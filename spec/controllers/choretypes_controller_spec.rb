...
describe ChoretypesController do
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Choretype" do
        expect {
          post :create, {:choretype => valid_attributes}, valid_session
        }.to change(Choretype, :count).by(1)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested choretype" do
        choretype = Choretype.create! valid_attributes
        # Assuming there are no other choretypes in the database, this
